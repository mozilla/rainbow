...
class NS_NO_VTABLE NS_SCRIPTABLE IMediaRecorder : public nsISupports {
 public: 
  ...
  /* [implicit_jscontext] void beginSession (in nsIPropertyBag2 prop, in nsIDOMCanvasRenderingContext2D canvasCtx, in nsIDOMHTMLAudioElement audioElement, in nsIMediaStateObserver obs); */
  NS_SCRIPTABLE NS_IMETHOD BeginSession(nsIPropertyBag2 *prop, nsIDOMCanvasRenderingContext2D *canvasCtx, nsIDOMHTMLAudioElement *audioElement, nsIMediaStateObserver *obs, JSContext *cx) = 0;

  /* void endSession (); */
  NS_SCRIPTABLE NS_IMETHOD EndSession(void) = 0;

  /* void beginRecording ([optional] in nsILocalFile file); */
...
#define NS_DECL_IMEDIARECORDER \
  NS_SCRIPTABLE NS_IMETHOD BeginSession(nsIPropertyBag2 *prop, nsIDOMCanvasRenderingContext2D *canvasCtx, nsIDOMHTMLAudioElement *audioElement, nsIMediaStateObserver *obs, JSContext *cx); \
...
#define NS_FORWARD_IMEDIARECORDER(_to) \
  NS_SCRIPTABLE NS_IMETHOD BeginSession(nsIPropertyBag2 *prop, nsIDOMCanvasRenderingContext2D *canvasCtx, nsIDOMHTMLAudioElement *audioElement, nsIMediaStateObserver *obs, JSContext *cx) { return _to BeginSession(prop, canvasCtx, audioElement, obs, cx); } \
...
#define NS_FORWARD_SAFE_IMEDIARECORDER(_to) \
  NS_SCRIPTABLE NS_IMETHOD BeginSession(nsIPropertyBag2 *prop, nsIDOMCanvasRenderingContext2D *canvasCtx, nsIDOMHTMLAudioElement *audioElement, nsIMediaStateObserver *obs, JSContext *cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->BeginSession(prop, canvasCtx, audioElement, obs, cx); } \
...
/* [implicit_jscontext] void beginSession (in nsIPropertyBag2 prop, in nsIDOMCanvasRenderingContext2D canvasCtx, in nsIDOMHTMLAudioElement audioElement, in nsIMediaStateObserver obs); */
NS_IMETHODIMP _MYCLASS_::BeginSession(nsIPropertyBag2 *prop, nsIDOMCanvasRenderingContext2D *canvasCtx, nsIDOMHTMLAudioElement *audioElement, nsIMediaStateObserver *obs, JSContext *cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
